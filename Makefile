...
clean :
	rm -f asyntax.cmi asyntax.cmo lexer.cmo lexer.cmi lexer.ml parser.cmi parser.cmo parser.ml parser.mli aritha aritha.cmi aritha.cmo rapport.log rapport.out rapport.pdf X86_64.cmo 
